...
<Steps>
  ...
  <Step title="Register your webhook endpoint">
    ...
    <Frame>
      <img src="/images/screenshots/image24.png" alt="Webhook Settings panel showing webhook URL, event checkboxes (Call Started, Call Ended, Call Analyzed, Transfer events), and Webhook Authentication toggle" />
    </Frame>
  </Step>
